...
import { LEVELS, getLevelDisplayName } from "@/lib/value-journey-types";
import type { PauseState } from "@/types/schema";
            ...
            <div className="grid grid-cols-4 gap-2">
              {BREAK_DURATIONS.map((duration) => (
                <Button
                  ...
                  size="sm"
                  className={`flex-col h-auto py-2 ${selectedDuration === duration.value && !useCustom
            ...
            {useCustom && (
              <div className="space-y-2">
                <Slider
                  ...
                  onValueChange={(value: number[]) => setCustomDuration(value[0])}
                  min={1}
                  max={720}
                  step={1}
                  className="py-2"
